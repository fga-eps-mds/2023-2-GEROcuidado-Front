...
export default function Inicial({ nome }: Props) {
  return (
    <View>
      <View style={styles.nameBar}>
        <Image source={require("../../../assets/Idoso.png")} style={styles.imagem} resizeMode="contain"/>
      ...
      >
        ...
        <View style={styles.buttonContainer}>
          <Image source={require("../../../assets/idoso_botao.png")} style={styles.imagemidosobotao} resizeMode="contain"/>
