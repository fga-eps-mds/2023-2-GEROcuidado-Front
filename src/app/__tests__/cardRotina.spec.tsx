...
describe('Teste Componente Card Rotina', () => {
    act(() => {
        ...
        test('Renderiza corretamente Card de exercicios', () => {
          const { getByText } = render(<CardRotina item={rotina_exercicios} index={0} date={new Date()} />);
        ...
        test('Renderiza corretamente Card de Medicamentos', () => {
          const { getByText } = render(<CardRotina item={rotina_medicamentos} index={0} date={new Date()} />);
